...
const renderTblBtn = (index, data ) =>{
    ...
    btnEdit.addEventListener('click', e =>{
        ...
        FORM.waste.value = data[index].waste
        FORM.washingmachine.checked = data[index].haswashingMachine
        FORM.dishwasher.checked = data[index].hasdishWasher
        FORM.steel.checked = data[index].recycleSteel
        FORM.plastic.checked = data[index].recyclePlastic
        FORM.paper.checked = data[index].recyclePaper
        FORM.aluminum.checked = data[index].recycleAluminum
        FORM.foodwaste.checked = data[index].recycleFoodWaste
        FORM.glass.checked = data[index].recycleGlass
        FORM.vehicleusage.value = data[index].vehicle
        FORM.flights.value = data[index].flights
        FORM.publictransportation.value = data[index].public
        onUpdate(index,data)
